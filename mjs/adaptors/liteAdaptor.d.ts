...
export declare class LiteBase extends AbstractDOMAdaptor<LiteElement, LiteText, LiteDocument> {
    ...
    domain(_doc?: LiteDocument | LiteElement): string;
    listener(listener: (event: any) => void, doc?: LiteDocument): void;
    post(msg: any, domain: string, doc?: LiteDocument): void;
    tags(node: LiteElement, name: string, ns?: string, stop?: number): LiteElement[];
    elementById(node: LiteElement, id: string): LiteElement;
    elementsByClass(node: LiteElement, name: string, stop?: number): LiteElement[];
    elementsByAttribute(node: LiteElement, name: string, value: string, stop?: number): LiteElement[];
    getElements(nodes: (string | LiteElement | LiteElement[])[], document: LiteDocument): LiteElement[];
    getElement(selector: string, node?: LiteElement | LiteDocument): LiteElement;
