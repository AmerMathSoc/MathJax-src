...
let BBoxStyle = function (styles) {
    return styles;
};
let BBoxPadding = function (pad) {
    return pad;
};
new CommandMap('bbox', { bbox: 'BBox' }, BboxMethods);
export const BboxConfiguration = Configuration.create('bbox', { handler: { macro: ['bbox'] } });
