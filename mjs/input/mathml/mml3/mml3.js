...
export class Mml3 {
    constructor(document) {
        if (typeof XSLTProcessor === 'undefined') {
            ...
            const parsed = document.adaptor.parse(Mml3.XSLT, 'text/xml');
...
export function Mml3Handler(handler) {
    var _a;
    handler.documentClass = (_a = class extends handler.documentClass {
            constructor(...args) {
                super(...args);
        ...
        _a.OPTIONS = Object.assign(Object.assign({}, handler.documentClass.OPTIONS), { enableMml3: true }),
        _a);
    return handler;
}
Mml3.XSLT = `
