...
exports.SvgMenclose = (function () {
    var _a;
    var Base = (0, menclose_js_1.CommonMencloseMixin)(Wrapper_js_1.SvgWrapper);
    return _a = (function (_super) {
            ...
            SvgMenclose.prototype.toSVG = function (parents) {
                var e_1, _a;
                ...
                var block = this.adaptor.append(svg[0], this.svg('g', def));
                if (this.renderChild) {
