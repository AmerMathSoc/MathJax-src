...
export declare type RENDERER<N, T, D> = Notation.Renderer<ChtmlMencloseNTD<N, T, D>, N>;
export declare type DEFPAIR<N, T, D> = Notation.DefPair<ChtmlMencloseNTD<N, T, D>, N>;
