                    ...
                    for (var _c = __values(this.tableRows), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        try {
                            for (var _e = (e_4 = void 0, __values(row.tableCells)), _f = _e.next(); !_f.done; _f = _e.next()) {
                                ...
                                var styleNode = (cell ? cell.dom[0] : this.adaptor.childNodes(row.dom[0])[i]);
            ...
            ChtmlMtable.prototype.handleColumnLines = function () {
                ...
                try {
                    for (var _c = __values(this.childNodes), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        var i = 0;
                        try {
                            for (var _e = (e_6 = void 0, __values(this.adaptor.childNodes(row.dom[0]).slice(1))), _f = _e.next(); !_f.done; _f = _e.next()) {
                                var cell = _f.value;
                                var line = lines[i++];
                                if (line === 'none')
                                    continue;
            ...
            ChtmlMtable.prototype.handleColumnWidths = function () {
                ...
                try {
                    for (var _c = __values(this.childNodes), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        var i = 0;
                        try {
                            for (var _e = (e_8 = void 0, __values(this.adaptor.childNodes(row.dom[0]))), _f = _e.next(); !_f.done; _f = _e.next()) {
                                var cell = _f.value;
                ...
                try {
                    for (var _c = __values(this.childNodes.slice(1)), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        if (line === 'none')
                            continue;
                        try {
                            for (var _e = (e_12 = void 0, __values(this.adaptor.childNodes(row.dom[0]))), _f = _e.next(); !_f.done; _f = _e.next()) {
                                var cell = _f.value;
