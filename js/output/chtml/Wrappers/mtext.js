...
exports.ChtmlMtext = (function () {
    ...
    return _a = (function (_super) {
            ...
            ChtmlMtext.prototype.toCHTML = function (parents) {
                ...
                try {
                    for (var _b = __values(chtml.keys()), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var i = _c.value;
                        var DOM = [chtml[i]];
                        this.adaptor.append(chtml[i], this.html('mjx-linestrut'));
                        var _d = __read(this.breakPoints[i - 1] || [0, 0], 2), si = _d[0], sj = _d[1];
                        var _e = __read(this.breakPoints[i] || [childNodes.length, 0], 2), ei = _e[0], ej = _e[1];
